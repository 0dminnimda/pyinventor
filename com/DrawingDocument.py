...
class DrawingDocument(DispatchBaseClass):
	'Drawing Document Object'
	CLSID = IID('{29F0D467-C114-11D2-B77F-0060B0F159EF}')
	coclass_clsid = IID('{BBF9FDF1-52DC-11D0-8C04-0800090BE8EC}')
	...
	def MakeAllViewsPrecise(self):
		'Set all drawing views in the document to be precise views.'
		return self._oleobj_.InvokeTypes(117440801, LCID, 1, (24, 0), (),)

	def MakeAllViewsRaster(self):
		'Set all drawing views in the document to be raster views.'
		return self._oleobj_.InvokeTypes(117440800, LCID, 1, (24, 0), (),)
	...
	def ProcessViewSelection(self, Selection=defaultNamedNotOptArg, ContainingView=pythoncom.Missing, SelectedObject=pythoncom.Missing):
		'Returns selection data for the input view selection'
		return self._ApplyTypes_(117440785, 1, (24, 0), ((9, 1), (16393, 2), (16393, 2)), 'ProcessViewSelection', None,Selection
			, ContainingView, SelectedObject)
	...
	def SaveAsInventorDWG(self, FullFileName=defaultNamedNotOptArg, SaveCopyAs=defaultNamedNotOptArg):
		'Saves the document as an Inventor DWG with the specified name'
		return self._oleobj_.InvokeTypes(117440789, LCID, 1, (24, 0), ((8, 1), (11, 1)),FullFileName
			, SaveCopyAs)
	...
	_prop_map_get_ = {
		...
		# Method 'ActiveSheet' returns object of type 'Sheet'
		"ActiveSheet": (117440770, 2, (9, 0), (), "ActiveSheet", '{206B59AE-22A6-11D4-B7A8-0060B0F159EF}'),
		...
		# Method 'AutoCADBlockDefinitions' returns object of type 'AutoCADBlockDefinitions'
		"AutoCADBlockDefinitions": (117440792, 2, (9, 0), (), "AutoCADBlockDefinitions", '{FC290B65-544A-4F65-B812-092CB93AA421}'),
		# Method 'BorderDefinitions' returns object of type 'BorderDefinitions'
		"BorderDefinitions": (117440774, 2, (9, 0), (), "BorderDefinitions", '{A907AEB1-A78F-11D5-8DF8-0010B541CAA8}'),
		...
		"ContainingDWGDocument": (117440787, 2, (9, 0), (), "ContainingDWGDocument", None),
		...
		"DisabledCommandList": (117440783, 2, (9, 0), (), "DisabledCommandList", '{81710E0C-B8F1-4D04-BDDF-AC92C274CC81}'),
		...
		# Method 'DrawingBOMs' returns object of type 'DrawingBOMs'
		"DrawingBOMs": (117440791, 2, (9, 0), (), "DrawingBOMs", '{68517DF3-9E1D-44AA-B12D-08880086D61A}'),
		# Method 'DrawingEvents' returns object of type 'DrawingEvents'
		"DrawingEvents": (117440782, 2, (13, 0), (), "DrawingEvents", '{C10BEC9D-DBA2-4035-9D15-11EA363B9A00}'),
		# Method 'DrawingSettings' returns object of type 'DrawingSettings'
		"DrawingSettings": (117440779, 2, (9, 0), (), "DrawingSettings", '{E493FF48-3A9A-4A71-9C0D-27D79B3138C2}'),
		# Method 'EnvironmentManager' returns object of type 'EnvironmentManager'
		"EnvironmentManager": (117440784, 2, (9, 0), (), "EnvironmentManager", '{2F5EC0C5-5335-4677-BB14-5621C1140D1B}'),
		...
		"IsInventorDWG": (117440788, 2, (11, 0), (), "IsInventorDWG", None),
		...
		"Parameters": (117440793, 2, (9, 0), (), "Parameters", '{528C9A32-4173-420A-AD05-B6FBF8382212}'),
		...
		# Method 'SheetFormats' returns object of type 'SheetFormats'
		"SheetFormats": (117440790, 2, (9, 0), (), "SheetFormats", '{6AC3D773-1202-450D-9CD2-3557B1395C64}'),
		# Method 'SheetSettings' returns object of type 'SheetSettings'
		"SheetSettings": (117440786, 2, (9, 0), (), "SheetSettings", '{EF8803D3-9ADF-4B81-9097-6529ED782861}'),
		# Method 'Sheets' returns object of type 'Sheets'
		"Sheets": (117440771, 2, (9, 0), (), "Sheets", '{206B59AF-22A6-11D4-B7A8-0060B0F159EF}'),
		# Method 'SketchSettings' returns object of type 'SketchSettings'
		"SketchSettings": (117440780, 2, (9, 0), (), "SketchSettings", '{02BCE85C-478B-4A66-8668-6579602A0EB6}'),
		# Method 'SketchedSymbolDefinitions' returns object of type 'SketchedSymbolDefinitions'
		"SketchedSymbolDefinitions": (117440778, 2, (9, 0), (), "SketchedSymbolDefinitions", '{A907AED1-A78F-11D5-8DF8-0010B541CAA8}'),
		...
		# Method 'StylesManager' returns object of type 'DrawingStylesManager'
		"StylesManager": (117440781, 2, (9, 0), (), "StylesManager", '{1A58DFEF-0B8C-44DF-97AF-4DAC85734B04}'),
		...
		# Method 'TitleBlockDefinitions' returns object of type 'TitleBlockDefinitions'
		"TitleBlockDefinitions": (117440775, 2, (9, 0), (), "TitleBlockDefinitions", '{A907AEB5-A78F-11D5-8DF8-0010B541CAA8}'),
		...
		# Method '_TextStyles' returns object of type 'TextStyles'
		"_TextStyles": (117440773, 2, (9, 0), (), "_TextStyles", '{A907AEBF-A78F-11D5-8DF8-0010B541CAA8}'),
	}
	_prop_map_put_ = {
...
win32com.client.CLSIDToClass.RegisterCLSID( "{29F0D467-C114-11D2-B77F-0060B0F159EF}", DrawingDocument )
