...
class _VbaImplementationPartEvents:
	'VbaImplementationPartEvents object.'
	CLSID = CLSID_Sink = IID('{4B98058A-A232-47FD-9186-1070297036FB}')
...
win32com.client.CLSIDToClass.RegisterCLSID( "{4B98058A-A232-47FD-9186-1070297036FB}", _VbaImplementationPartEvents )
