...
class ReferencedFileDescriptors(DispatchBaseClass):
	'Object that holds a collection of ReferencedFileDescriptor interfaces'
	CLSID = IID('{9E0BA9CB-E916-11D2-B785-0060B0F159EF}')
	coclass_clsid = None

	# Result is of type ReferencedFileDescriptor
	...
	def Item(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Item', '{9E0BA9CA-E916-11D2-B785-0060B0F159EF}')
		return ret
	...
	def ItemByName(self, Name=defaultNamedNotOptArg):
		...
		ret = self._oleobj_.InvokeTypes(2130706471, LCID, 2, (9, 0), ((8, 1),),Name
			)
		if ret is not None:
			ret = Dispatch(ret, 'ItemByName', '{9E0BA9CA-E916-11D2-B785-0060B0F159EF}')
		return ret
	...
	def __call__(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, '__call__', '{9E0BA9CA-E916-11D2-B785-0060B0F159EF}')
		return ret
	...
	def __iter__(self):
		...
		return win32com.client.util.Iterator(ob, '{9E0BA9CA-E916-11D2-B785-0060B0F159EF}')
...
win32com.client.CLSIDToClass.RegisterCLSID( "{9E0BA9CB-E916-11D2-B785-0060B0F159EF}", ReferencedFileDescriptors )
