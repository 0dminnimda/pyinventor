...
class Application(DispatchBaseClass):
	...
	def ConstructInternalNameAndRevisionId(self, InternalNameToken=defaultNamedNotOptArg, RevisionIdToken=defaultNamedNotOptArg, InternalName=pythoncom.Missing, RevisionId=pythoncom.Missing):
		...
		return self._ApplyTypes_(50332020, 1, (24, 0), ((8, 1), (8, 1), (16392, 2), (16392, 2)), 'ConstructInternalNameAndRevisionId', None,InternalNameToken
			, RevisionIdToken, InternalName, RevisionId)

	# Result is of type FactoryTableDialog
	def CreateFactoryTableDialog(self, FullFileName=defaultNamedNotOptArg):
		'Creates a Factory Table dialog'
		ret = self._oleobj_.InvokeTypes(50332163, LCID, 1, (9, 0), ((8, 1),),FullFileName
			)
		if ret is not None:
			ret = Dispatch(ret, 'CreateFactoryTableDialog', '{1052B04A-487B-446C-AAAD-90CD3BCCAC9E}')
		return ret

	def CreateFileDialog(self, Dialog=pythoncom.Missing):
		'Creates a file dialog'
		return self._ApplyTypes_(50331981, 1, (24, 0), ((16393, 2),), 'CreateFileDialog', None,Dialog
			)
	...
	def CreateInternalName(self, Name=defaultNamedNotOptArg, Number=defaultNamedNotOptArg, Custom=defaultNamedNotOptArg, InternalName=pythoncom.Missing):
		...
		return self._ApplyTypes_(50331967, 1, (24, 0), ((8, 1), (8, 1), (8, 1), (16392, 2)), 'CreateInternalName', None,Name
	...
	def CreateProgressBar(self, DisplayInStatusBar=defaultNamedNotOptArg, NumberOfSteps=defaultNamedNotOptArg, Title=defaultNamedNotOptArg, AllowCancel=False
		...
		if ret is not None:
			...
			try:
				...
				return ret
			ret = Dispatch(ret, 'CreateProgressBar', '{8574FEAB-B050-439E-AC97-9704A217E5A1}')
		return ret
	...
	def GetAppFrameExtents(self, Top=pythoncom.Missing, Left=pythoncom.Missing, Height=pythoncom.Missing, Width=pythoncom.Missing):
		...
		return self._ApplyTypes_(50331915, 1, (24, 0), ((16387, 2), (16387, 2), (16387, 2), (16387, 2)), 'GetAppFrameExtents', None,Top
			, Left, Height, Width)
	...
	def GetInterfaceObject32(self, ProgIDorCLSID=defaultNamedNotOptArg):
		...
		if ret is not None:
			...
			try:
				...
				return ret
			ret = Dispatch(ret, 'GetInterfaceObject32', None)
		return ret

	def GetMDIClientAreaExtents(self, Top=pythoncom.Missing, Left=pythoncom.Missing, Height=pythoncom.Missing, Width=pythoncom.Missing):
		"Obtains the position and size of the Application's MDI client area."
		return self._ApplyTypes_(50332162, 1, (24, 0), ((16387, 2), (16387, 2), (16387, 2), (16387, 2)), 'GetMDIClientAreaExtents', None,Top
			, Left, Height, Width)

	# Result is of type PluginLicenseManager
	def GetPluginLicenseManager(self, ProductKey=defaultNamedNotOptArg, ProductVersion=defaultNamedNotOptArg, BrandingImagePath=defaultNamedOptArg):
		'Hidden method. Not for public use. Returns a PluginLicenseManager object.'
		ret = self._oleobj_.InvokeTypes(50332073, LCID, 1, (9, 0), ((8, 1), (8, 1), (12, 17)),ProductKey
			, ProductVersion, BrandingImagePath)
		if ret is not None:
			ret = Dispatch(ret, 'GetPluginLicenseManager', '{BC3FDF84-449A-4C14-A825-473FDB60C433}')
		return ret

	def GetSubscriptionEnablerStatus(self, VersionNumber=defaultNamedNotOptArg):
		'Gets the subscription enabler status for the specified version.'
		return self._oleobj_.InvokeTypes(50332160, LCID, 1, (3, 0), ((8, 1),),VersionNumber
			)
	...
	def RefreshRibbonForComparison(self):
		'Method that refreshes the ribbon controls display when the comparison is set.'
		return self._oleobj_.InvokeTypes(50332168, LCID, 1, (24, 0), (),)

	def ReserveLicense(self, ClientId=defaultNamedNotOptArg):
		'Informs Inventor/Apprentice that a license should be retained for this instace of the application. Used to prevent idle detection from returning the seat license to the license pool. Requires a call to UnreserveLicense with teh same ClientID to allow the licen'
	...
	def _CanMigrateCustomSettings(self, CustomSettingsType=defaultNamedNotOptArg, FromBuildIdentifier=defaultNamedNotOptArg):
		'Hidden method. Not for public use. Determines if migration is possible for specified settings and version'
		return self._oleobj_.InvokeTypes(50332069, LCID, 1, (11, 0), ((3, 1), (8, 1)),CustomSettingsType
			, FromBuildIdentifier)
	...
	def _ConstructInternalNameAndFileVersion(self, Name=defaultNamedNotOptArg, Number=defaultNamedNotOptArg, Custom=defaultNamedNotOptArg, Revision=defaultNamedNotOptArg
		...
		'*** DEFUNCT SINCE R5.3'
		return self._ApplyTypes_(50331951, 1, (24, 0), ((8, 1), (8, 1), (8, 1), (8, 1), (16392, 2), (16392, 2)), '_ConstructInternalNameAndFileVersion', None,Name
			, Number, Custom, Revision, InternalName, FileVersion
			)

	# The method _DefaultDocType is actually a property, but must be used as a method to correctly pass the arguments
	def _DefaultDocType(self, FileName=defaultNamedNotOptArg, Result=pythoncom.Missing):
		'Hidden method. Not for public use. Determines the default document type.'
		return self._ApplyTypes_(50332068, 2, (11, 0), ((8, 1), (16387, 2)), '_DefaultDocType', None,FileName
			, Result)
	...
	def _GetShapeManagerVersion(self, MajorVersion=pythoncom.Missing, MinorVersion=pythoncom.Missing, PointVersion=pythoncom.Missing):
		...
		return self._ApplyTypes_(50331971, 1, (24, 0), ((16387, 2), (16387, 2), (16387, 2)), '_GetShapeManagerVersion', None,MajorVersion
			, MinorVersion, PointVersion)

	# The method _IsFileVersionSupported is actually a property, but must be used as a method to correctly pass the arguments
	def _IsFileVersionSupported(self, FileName=defaultNamedNotOptArg):
		'Hidden method. Not for public use. Determines if input filename can be opened by this version of Inventor.'
		return self._oleobj_.InvokeTypes(50332064, LCID, 2, (11, 0), ((8, 1),),FileName
			)

	# The method _IsInventorFile is actually a property, but must be used as a method to correctly pass the arguments
	def _IsInventorFile(self, FileName=defaultNamedNotOptArg):
		'Hidden method. Not for public use. Determines if input filename is an Inventor file.'
		return self._oleobj_.InvokeTypes(50332065, LCID, 2, (11, 0), ((8, 1),),FileName
			)
	...
	def _MigrateCustomSettings(self, CustomSettingsType=defaultNamedNotOptArg, FromBuildIdentifier=defaultNamedNotOptArg):
		'Hidden method. Not for public use. Migrates specified settings from version'
		return self._oleobj_.InvokeTypes(50332070, LCID, 1, (11, 0), ((3, 1), (8, 1)),CustomSettingsType
			, FromBuildIdentifier)
	...
	def _MigrateStylesLibrary(self, LibraryPath=defaultNamedNotOptArg, Result=pythoncom.Missing, NumLibraries=pythoncom.Missing):
		...
		return self._ApplyTypes_(50332004, 1, (24, 0), ((8, 1), (16392, 2), (16387, 2)), '_MigrateStylesLibrary', None,LibraryPath
			, Result, NumLibraries)
	...
	def _RegistryEntry(self, SubKey=defaultNamedNotOptArg, ValueName=defaultNamedNotOptArg, RegistryHive=defaultNamedNotOptArg):
		...
		return self._ApplyTypes_(50331934, 2, (12, 0), ((8, 1), (8, 1), (3, 1)), '_RegistryEntry', None,SubKey
			, ValueName, RegistryHive)
	...
	_prop_map_get_ = {
		...
		"AllowDataCollectionForAnalyticsPrograms": (50332165, 2, (11, 0), (), "AllowDataCollectionForAnalyticsPrograms", None),
		...
		"AvailableComparisonVersions": (50332166, 2, (8200, 0), (), "AvailableComparisonVersions", None),
		...
		"ComparisonVersion": (50332167, 2, (8, 0), (), "ComparisonVersion", None),
		...
		"IsIn3dPrintMode": (50332164, 2, (11, 0), (), "IsIn3dPrintMode", None),
		...
		# Method 'ThemeManager' returns object of type 'ThemeManager'
		"ThemeManager": (50332169, 2, (9, 0), (), "ThemeManager", '{388C8482-AC37-4E41-8B59-DC4A2F6BFE45}'),
		...
		# Method 'WebBrowserDialogs' returns object of type 'WebBrowserDialogs'
		"WebBrowserDialogs": (50332161, 2, (9, 0), (), "WebBrowserDialogs", '{077CE0DB-81E9-4A4C-B0D3-C5C33B3128A4}'),
		...
		# Method '_CustomDataEvents' returns object of type 'CustomDataEvents'
		"_CustomDataEvents": (50332071, 2, (13, 0), (), "_CustomDataEvents", '{D20F6BBC-3EE9-4511-9467-8BED325214EC}'),
		...
		"_IsReplayingTranscript": (50332057, 2, (11, 0), (), "_IsReplayingTranscript", None),
		"_IsTranscriptingOn": (50332066, 2, (11, 0), (), "_IsTranscriptingOn", None),
		"_LibraryDocumentModifiable": (50332072, 2, (11, 0), (), "_LibraryDocumentModifiable", None),
		# Method '_PublicationEvents' returns object of type 'PublicationEvents'
		"_PublicationEvents": (50332067, 2, (13, 0), (), "_PublicationEvents", '{F3041103-5E4E-4045-806D-24A901AAD449}'),
	...
	_prop_map_put_ = {
		...
		"ComparisonVersion": ((50332167, LCID, 4, 0),()),
		...
		"_IsTranscriptingOn": ((50332066, LCID, 4, 0),()),
		"_LibraryDocumentModifiable": ((50332072, LCID, 4, 0),()),
